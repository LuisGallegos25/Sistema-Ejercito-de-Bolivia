...
<body>
    <div id="wrapper">
        ...
        <form action="../EliminarSoldado/eliminarSoldado1.php" method="post">
...
<center><input class="botonn" type="submit" value="ELIMINAR SOLDADO"></center>
